...
def FE1(data):
    class Classification(GeneticFunctions):
    ...
    GeneticAlgorithm(Classification(data)).run()
pass
def loaddata(filename):
    with open(filename, 'r') as fname:
    #data_url = 'http://bit.ly/2cLzoxH'
# read data from url as pandas dataframe
        gapminder = pd.read_csv(fname)
# does year equals to 2002?
# is_2002 is a boolean variable with True or False in it
        is_2002 =  gapminder['pc']<= 'PC-4736'
        is_2003 =  gapminder['pc']>= 'PC-6204'
#print(is_2002.head())
        gapminder_2002 = gapminder[is_2002]
        gapminder_2003 = gapminder[is_2003]
        print(gapminder_2002.head())
        print(gapminder_2003.head())
